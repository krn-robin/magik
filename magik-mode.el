...
(defface magik-argument-face
  ...
  "Font Lock mode face used when displaying arguments for methods."
  :group 'magik-faces)

(defface magik-boolean-face
  '((t (:inherit font-lock-variable-name-face)))
  "Font Lock mode face used when displaying boolean and kleenean references."
  :group 'magik-faces)
...
(defface magik-bracket-face
  ...
  "Font Lock mode face used when displaying brackets and parens."
  :group 'magik-faces)

(defface magik-character-face
  '((t (:inherit font-lock-constant-face)))
  "Font Lock mode face used when displaying characters."
  :group 'magik-faces)

(defface magik-class-face
  '((t (:inherit font-lock-type-face)))
  "Font Lock mode face used when displaying exemplars."
  :group 'magik-faces)

(defface magik-comment-face
  '((t (:inherit font-lock-comment-face)))
  "Font Lock mode face used when displaying comments."
  :group 'magik-faces)

(defface magik-constant-face
  '((t (:inherit font-lock-constant-face)))
  "Font Lock mode face used when displaying constants."
  :group 'magik-faces)
...
(defface magik-delimiter-face
  ...
  "Font Lock mode face used when displaying delimiters."
  :group 'magik-faces)

(defface magik-doc-face
  '((t (:inherit font-lock-doc-face)))
  "Font Lock mode face used when displaying documentation."
  :group 'magik-faces)

(defface magik-keyword-operators-face
  '((t (:inherit font-lock-keyword-face)))
  "Font Lock mode face used when displaying Magik operator keywords."
  :group 'magik-faces)

(defface magik-keyword-statements-face
  '((t (:inherit font-lock-keyword-face)))
  "Font Lock mode face used when displaying Magik statement keywords."
  :group 'magik-faces)

(defface magik-keyword-loop-face
  '((t (:inherit font-lock-keyword-face)))
  "Font Lock mode face used when displaying Magik loop keywords."
  :group 'magik-faces)

(defface magik-keyword-arguments-face
  '((t (:inherit font-lock-keyword-face)))
  "Font Lock mode face used when displaying Magik argument keywords."
  :group 'magik-faces)

(defface magik-dynamic-face
  '((t (:inherit font-lock-variable-name-face)))
  "Font Lock mode face used when displaying dynamic variables."
  :group 'magik-faces)

(defface magik-global-face
  '((t (:inherit font-lock-variable-name-face)))
  "Font Lock mode face used when displaying global variables."
  :group 'magik-faces)

(defface magik-global-reference-face
  '((t (:inherit font-lock-constant-face)))
  "Font Lock mode face used when displaying global references."
  :group 'magik-faces)

(defface magik-keyword-variable-face
  '((t (:inherit font-lock-variable-name-face)))
  "Font Lock mode face used when displaying Magik variable keywords."
  :group 'magik-faces)

(defface magik-keyword-obsolete-face
  '((t (:inherit font-lock-warning-face)))
  "Font Lock mode face used when displaying obsolete Magik keywords."
  :group 'magik-faces)

(defface magik-method-face
  '((t (:inherit font-lock-function-name-face)))
  "Font Lock mode face used when displaying method names & method/procedure keywords."
  :group 'magik-faces)

(defface magik-label-face
  '((t (:inherit font-lock-variable-name-face)))
  "Font Lock mode face used when displaying labels for loops."
  :group 'magik-faces)
...
(defface magik-number-face
  ...
  "Font Lock mode face used when displaying numbers."
  :group 'magik-faces)
...
(defface magik-operator-face
  ...
  "Font Lock mode face used when displaying operators."
  :group 'magik-faces)

(defface magik-pragma-face
  '((t (:inherit font-lock-builtin-face)))
  "Font Lock mode face used when displaying pragma directives."
  :group 'magik-faces)

(defface magik-procedure-face
  '((t (:inherit font-lock-function-name-face)))
  "Font Lock mode face used when displaying procedure calls."
  :group 'magik-faces)

(defface magik-slot-face
  '((t (:inherit font-lock-variable-name-face)))
  "Font Lock mode face used when displaying slots."
  :group 'magik-faces)

(defface magik-symbol-face
  '((t (:inherit font-lock-constant-face)))
  "Font Lock mode face used when displaying symbols."
  :group 'magik-faces)

(defface magik-string-face
  '((t (:inherit font-lock-string-face)))
  "Font Lock mode face used when displaying strings."
  :group 'magik-faces)

(defface magik-variable-face
  '((t (:inherit font-lock-variable-name-face)))
  "Font Lock mode face used when displaying variables."
  :group 'magik-faces)

(defface magik-warning-face
  '((t (:inherit font-lock-warning-face)))
  "Font Lock mode face used when displaying warning statements."
  :group 'magik-faces)

(defface magik-write-face
  '((t (:inherit font-lock-warning-face)))
  "Font Lock mode face used when displaying write() statements."
  :group 'magik-faces)
...
(defun magik-transmit-buffer ()
  "Send the buffer to the process running in the buffer in the var, `magik-session-buffer'."
  (interactive)
